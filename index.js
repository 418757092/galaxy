...
const UUID = process.env.UUID || 'cc286f1f-36c2-401c-a898-6144464b7446'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || '2h1TEmM79EPLBctbNrd014hWlkZ3Sr26';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'galaxy.6665.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || '{"AccountTag":"4d1cc7779919995aa16debbdab8892bd","TunnelSecret":"gLrwukZ5Zax0ltMGI1wdLeOYetciVItnjELYPc+PuGM=","TunnelID":"d5a6604d-5b3e-410b-ba3a-673363938453","Endpoint":""}';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
